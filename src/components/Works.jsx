        ...
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
            <div
              ...
              className="black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer mb-4"
            >
              <img
                src={github}
                alt="source code"
    ...
    <>
      ...
      <div className="w-full flex">
        <p className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">
          The following projects highlight my skills and hands-on experience through real-world problem-solving and practical applications. Each project demonstrates my ability to work with diverse technologies, build scalable solutions, and manage development workflows efficiently while focusing on performance, usability, and impact.
        </p>
      </div>
